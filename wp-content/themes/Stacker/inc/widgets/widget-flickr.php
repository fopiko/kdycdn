...
class themefurnace_Widget_Flickr extends WP_Widget
{
	...
	function form( $instance )
	{
		...
		<div class="widget-controls">
			...
			<p>
				<label
					for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'themefurnace' ); ?></label>
			...
			<p>
				...
				<input class="widefat" id="<?php echo $this->get_field_id( 'id' ); ?>"
					   ...
					   value="<?php echo esc_attr( $instance['id'] ); ?>" type="text"/>
			</p>

			<p>
				<label
					for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e( 'Limit:', 'themefurnace' ); ?></label>
			...
			<p>
				<label
					for="<?php echo $this->get_field_id( 'display' ); ?>"><?php _e( 'Display:', 'themefurnace' ); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id( 'display' ); ?>"
					...
					<?php foreach ( $display as $option_value => $option_label ) { ?>
						<option
							value="<?php echo esc_attr( $option_value ); ?>" <?php selected( $instance['display'], $option_value ); ?>><?php echo esc_html( $option_label ); ?></option>
					<?php } ?>
				</select>
			</p>
			...
			<p>
				<label
					for="<?php echo $this->get_field_id( 'type' ); ?>"><?php _e( 'Type:', 'themefurnace' ); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id( 'type' ); ?>"
						name="<?php echo $this->get_field_name( 'type' ); ?>">
					<?php foreach ( $type as $option_value => $option_label ) { ?>
						<option
							value="<?php echo esc_attr( $option_value ); ?>" <?php selected( $instance['type'], $option_value ); ?>><?php echo esc_html( $option_label ); ?></option>
					<?php } ?>
				</select>
			</p>
